...
from core.execution.base import ExecutionStatus, ExecutionLogs, ExecutionResult as ExecRes
...
async def test_evaluation_manager_with_php_missing_runtime():
    ...
    # Run php evaluation with php missing on PATH
    # Since we know php is missing on this host, it will naturally hit the fallback
